          ...
          <div className="side-panel animate-slide">
            <div className="side-panel-header">
              <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 8 }}>
                ...
                <button className="btn mobile-flex-only" onClick={() => setSettOpen(false)} style={{ padding: "6px 12px", background: t.bg3, border: `1px solid ${t.border}`, color: t.text }}>Volver</button>
              </div>
